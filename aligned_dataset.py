...
class AlignedHiggsAudioDataset(Dataset):
    """Optimized dataset for Higgs Audio training with zero-shot voice cloning support."""
...
def create_aligned_collator(config, whisper_processor):
